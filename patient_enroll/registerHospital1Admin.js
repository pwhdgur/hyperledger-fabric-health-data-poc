...
// const utils = require('./organizationConstant.json')
...
async function main() {
  try {
    ...
    const ccpPath = path.resolve(__dirname, '..', '..', '..', 'fabric-samples/patient_project/patient_network/test-network', 'organizations', 'peerOrganizations', 'org1.example.com', 'connection-org1.json')
